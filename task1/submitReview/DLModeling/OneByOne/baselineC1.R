...
finalData   <- finalData[intersectionTollgate=='C1',]
...
write.table(ATTNNSubmit,file=paste(Sys.Date(), "OBOC1.csv", sep=""),  row.names=F,col.names=F, quote=F, sep=",")

save(ATTNNSubmit,DLGridResult,modelResult,modelSummary,file=paste(Sys.Date(), "OBOC1.Rdata", sep=""))
